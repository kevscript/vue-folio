    ...
    <div class="container">
      <section class="header">
        ...
        <div class="header-menu">
          <router-link to="projects/gonerank" class="header-link"
            >Projects</router-link
          >
          <a
            href="./resume.pdf"
            download="Kevin Ostafinski - CV Front-End Developer"
            class="header-anchor"
          >
            Resume
      ...
      <section class="what">
        <div class="what-flex">
          <div class="what-content">
            ...
            <p>
              I'm able to integrate pixel perfect designs and build interactive
              web applications from the ground up, following the latest
              standards and technologies.
            </p>
            <p>
              Eager to improve and expand my skillset, I'm
              <span>looking for opportunities</span> to collaborate with other
              developers on exciting projects and share knowledge with the
              community.
            </p>
          </div>
      ...
      <section class="projects">
        ...
        <div class="projects-container">
          <router-link to="/projects/gonerank" class="project">
            <div class="mask">
              <h3>GoneRank</h3>
              <span>Apr. 2020</span>
            </div>
            <img src="../assets/gonerank/gonerank1.jpg" alt="" />
          </router-link>
      ...
      <section class="faq">
        ...
        <div class="faq-list">
          <div class="faq-item">
            ...
            <p>
              Yes, I'm currently looking for a full time position in Paris or
              work remotely as a Front-End / React developer. You can download
              my
              <a
                href="./resume.pdf"
                download="Kevin Ostafinski - CV Front-End Developer"
          ...
          <div class="faq-item">
            ...
            <p>
              The best way of getting in touch is simply through my
              <a href="mailto:kevinostafinski@gmail.com">email</a>. You can also
              message me via
              <a
          ...
          <div class="faq-item">
            ...
            <p>
              Most of my public projects are available for you on my
              <a
